/**
 * Barrel de helpers compartilhados do App — movido de App.jsx.
 * Exporta: S (estilos), API, helpers de role e de risco.
 * Auth functions vêm de utils/api.js (evitar duplicação).
 */

export { authFetch, getToken, getUser, saveAuth, clearAuth } from "../utils/api";

export const API = import.meta.env.VITE_API_URL ?? "https://riggingcheck-production.up.railway.app";

export const IS_SUPER = (role) => role === "SUPER_ADMIN";

export const statusColor = (s) =>
  s === "PROSSEGUIR" ? "#22c55e" : s === "PARAR" ? "#ef4444" : "#f59e0b";

export const riskColor = (level) => {
  if (level === "SAFE")    return { color: "#22c55e", bg: "#052e16" };
  if (level === "WARNING") return { color: "#f59e0b", bg: "#2d1900" };
  return { color: "#ef4444", bg: "#1c0a0a" };
};
